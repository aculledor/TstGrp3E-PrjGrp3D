...
class Test_P9_CrearIncidencia {
	...
	@Test
	@DisplayName("Test_P9_CrearIncidencia: caminos válidos (CP113, CP119-CP122)")
	void P9_CrearIncidencia_CV() throws Exception {
		...
		assertAll(() -> {
			assertDoesNotThrow(() -> {
				...
				}, "(CP113) La creación de la incidencia con valores válidos y caso: "
				...
				() -> {
					...
					}, "(CP119) La creación de la incidencia con valores válidos y caso: "
				...
				() -> {
					assertDoesNotThrow(() -> {
						...
						}, "(CP120) La creación de la incidencia con valores válidos y caso: "
				...
				() -> {
					...
					}, "(CP121) La creación de la incidencia con valores válidos y caso: "
				...
				() -> {
					...
					}, "(CP122) La creación de la incidencia con valores válidos y caso: "
	...
	@Test
	@DisplayName("Test_P9_CrearIncidencia: caminos no válidos (CP098-CP112, CP114-CP117)")
	void P9_CrearIncidencia_CNV() throws Exception {
		...
		assertAll(
				...
				() -> {
					...
					}, "(CP109) La creación de la incidencia con valores no válidos y caso: "
							+ "(telefono.length() < 9) no lanza una excepción.");
					assertEquals("longitud de numero de teléfono no válida", ex.getMessage(),
							"(CP109) La creación del proceso con valores no válidos y caso: "
				...
				() -> {
					...
					}, "(CP110) La creación de la incidencia con valores no válidos y caso: "
							+ "(telefono.length() > 40) no lanza una excepción.");
					assertEquals("longitud de numero de teléfono no válida", ex.getMessage(),
							"(CP110) La creación del proceso con valores no válidos y caso: "
				...
				() -> {
					Exception ex = assertThrows(Exception.class, () -> {
						GI.crearIncidencia("Jose maria", "49665809T", "693633448", fechaDate, "Descripción de proba que excede o tamaño máximo de palabras aceptado. Asdasdasdasdasdasdasdasdas"
								...
								"Santiago","Suministro");
					}, "(CP115) La creación de la incidencia con valores no válidos y caso: "
							+ "(descripcion.length() > 400) no lanza una excepción.");
					assertEquals("descripcion demasiado larga", ex.getMessage(),
							"(CP115) La creación del proceso con valores no válidos y caso: "
				...
				() -> {
					...
					}, "(CP116) La creación de la incidencia con valores no válidos y caso: "
							+ "(localizacion.length() > 100) no lanza una excepción.");
					assertEquals("localizacion demasiado larga", ex.getMessage(),
							"(CP116) La creación del proceso con valores no válidos y caso: "
				...
				() -> {
					Exception ex = assertThrows(Exception.class, () -> {
						GI.crearIncidencia("Jose maria", "49665809T", "693633448", fechaDate, "descripcion",
								"Santiago","Vecindario");
					}, "(CP117) La creación de la incidencia con valores no válidos y caso: "
							+ "(tipo = Vecindario) no lanza una excepción.");
					assertEquals("tipo no válido", ex.getMessage(),
							"(CP117) La creación del proceso con valores no válidos y caso: "

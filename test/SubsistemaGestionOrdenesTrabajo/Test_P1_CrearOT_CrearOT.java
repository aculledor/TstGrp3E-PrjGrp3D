...
class Test_P1_CrearOT_CrearOT {
	...
	class EntradasValidas {
		@Test
		@DisplayName("CP046-P1-CrearOT: estado = Sin comenzar")
		void testCP46CrearOT() throws Exception {
			// Arrange
		...
		@Test
		@DisplayName("CP047-P1-CrearOT: valores válidos(nulls) y estado = Iniciado")
		void testCP47CrearOT() throws Exception {
			// Arrange
			ArrayList<Incidencia> simIncidencias = new ArrayList<>();
			ArrayList<Proceso> simProcesos= new ArrayList<>();
			simIncidencias.add(new Incidencia(1, null, null, null, null, null, null, null));
		...
		@Test
		@DisplayName("CP048-P1-CrearOT: valores válidos y estado = Avanzado")
		...
		@Test
		@DisplayName("CP049-P1-CrearOT: estado = Finalizado ")
		...
		@Test
		@DisplayName("CP050-P1-CrearOT: estado = null")
	...
	class EntradasNoValidas {
		@Test
		@DisplayName("CP051-CP064-P1-CrearOT:  Casos no válidos (CP051 - CP064)")
		void testCP51_CP64CrearOT() throws Exception {
			// Arrange
			ArrayList<Incidencia> simIncidencias = new ArrayList<>();
			ArrayList<Proceso> simProcesos= new ArrayList<>();
			simIncidencias.add(new Incidencia(1, null, null, null, null, null, null, null));
			...
			assertAll(
					()->{Exception e = assertThrows(Exception.class, ()->{GOT.crearOrdenTrabajo("responsableResponsableResponsab", "sin comenzar", 20, fecha, "Texto de ejemplo",
							(float) 100.25, "ladrillos", personal, null, 2);},
							"(CP051) La creación de la OT con valores no válidos y caso: "
					...
					()->{Exception e = assertThrows(Exception.class, ()->{GOT.crearOrdenTrabajo("responsable", "Realizado", 20, fecha, "Texto de ejemplo",
							(float) 100.25, "ladrillos", personal, null, 2);},
							"(CP052) La creación de la OT con valores no válidos y caso: "
	...
	class Rendimiento{
		@Test
		@DisplayName("Test_P1_CrearOT_CrearOT: Prueba de rendimiento (Caso válido CP046)")
		void P1_CrearOT_CrearOT_Rendimiento() {
			...
			assertTimeoutPreemptively(Duration.ofSeconds(2), ()->{ GOT.crearOrdenTrabajo("responsable", "sin comenzar", 20, fecha, "Texto de ejemplo",
					(float) 100.25, "ladrillos", personal, null, 2);},
					"(CP046) La creación de la orden de trabajo supera el límite temporal de respuesta requerido.");
		}
	}
